...
namespace RecetaTipicaRD.Application.Service
{
    public class UsuarioDeportivoService : IUsuarioRTService
    {
        ...
        public async Task Actualizar(UsuarioRTDto usuarioDto)
        {
            Validar(usuarioDto);
